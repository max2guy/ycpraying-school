...
const MISSION_SCHEDULE = [
    { date:'2026-07-20', day:1, label:'1일차', range:'사도행전 2:1-13 전체', desc:'성령강림과 방언 — 사도행전 2장 1절부터 13절까지, 총 13절 전부를 손으로 필사한 후 사진으로 인증하세요! ✍️', background:'오순절에 성령께서 제자들에게 임하셨고, 여러 나라에서 온 사람들이 각자의 언어로 하나님의 큰일을 듣게 된 장면입니다.' },
    { date:'2026-07-21', day:2, label:'2일차', range:'사도행전 2:14-21 전체', desc:'베드로의 설교 ① 요엘의 예언 — 사도행전 2장 14절부터 21절까지, 총 8절 전부를 손으로 필사한 후 사진으로 인증하세요! ✍️', background:'베드로는 이 사건이 혼란이 아니라, 요엘을 통해 약속하신 성령의 역사라고 설명합니다.' },
    { date:'2026-07-22', day:3, label:'3일차', range:'사도행전 2:22-28 전체', desc:'베드로의 설교 ② 그리스도의 죽음과 부활 — 사도행전 2장 22절부터 28절까지, 총 7절 전부를 손으로 필사한 후 사진으로 인증하세요! ✍️', background:'베드로는 예수님의 십자가와 부활이 하나님의 뜻 가운데 이루어진 구원의 사건임을 선포합니다.' },
    { date:'2026-07-23', day:4, label:'4일차', range:'사도행전 2:29-36 전체', desc:'베드로의 설교 ③ 주와 그리스도 — 사도행전 2장 29절부터 36절까지, 총 8절 전부를 손으로 필사한 후 사진으로 인증하세요! ✍️', background:'시편의 말씀을 통해, 다윗이 기다렸던 메시아가 부활하신 예수님이며 예수님이 주와 그리스도이심을 증언합니다.' },
    { date:'2026-07-24', day:5, label:'5일차', range:'사도행전 2:37-41 전체', desc:'회개와 세례, 삼천 명의 회심 — 사도행전 2장 37절부터 41절까지, 총 5절 전부를 손으로 필사한 후 사진으로 인증하세요! ✍️', background:'말씀을 들은 사람들이 마음에 찔려 회개하고 세례를 받으며 믿음의 공동체에 참여하게 됩니다.' },
    { date:'2026-07-25', day:6, label:'6일차', range:'사도행전 2:42-47 전체', desc:'초대교회의 공동체 생활 — 사도행전 2장 42절부터 47절까지, 총 6절 전부를 손으로 필사한 후 사진으로 인증하세요! ✍️', background:'초대교회 성도들은 말씀을 배우고 함께 기도하며 나누고 섬기는 삶으로 하나님께 기쁨을 드렸습니다.' },
    { date:'2026-07-26', day:7, label:'주일',  range:'사도행전 2:17 암송', desc:'사도행전 2장 17절을 암송한 뒤 선생님께 직접 확인받아 주세요. 앱에서 사진이나 기도문을 인증할 필요는 없습니다.', background:'한 주 동안 필사한 말씀을 돌아보며, 성령의 역사와 예수 그리스도의 복음을 마음에 새기는 시간입니다.', noSubmit:true },
];
    ...
    try {
        ...
        msg.onMessage(payload => {
            ...
            navigator.serviceWorker.ready
                ...
                .catch(() => showWeatherToast(title, body));
        });
...
function toggleAmen(i, e) {
    ...
    const amenRef = membersRef.child(`${currentMemberData.firebaseKey}/prayers/${i}/amens/${mySessionId}`);
    amenRef.transaction(current => current ? null : true, (error, committed, snapshot) => {
        if (error || !committed) {
            showWeatherToast('아멘 저장 실패', '잠시 후 다시 눌러주세요.');
            return;
        }
